...
RUN cd /usr/local/JavaDocker && mvn assembly:assembly
...
CMD ["java", "-cp", "/usr/local/JavaDocker/target/JavaDocker-1.0-SNAPSHOT.jar", "com.slinger.docker.HelloWorldPing"]
